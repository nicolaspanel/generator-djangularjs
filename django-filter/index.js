...
var ModuleGenerator = yeoman.generators.NamedBase.extend({
    ...
    renderModule: function() {
        ...
        this.template('_.templatetags.filter.py', format('server/{0}/templatetags/{1}.py', this.underscoredModuleName, this.underscoredName));
        ...
        this.template('_.tests.filter.py', format('server/{0}/tests/test_{1}_filter.py', this.underscoredModuleName, this.underscoredName));
    }
});
